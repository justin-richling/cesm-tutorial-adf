...
# # CAM vs Obs
# 
# This will be a simple guided demo of running the ADF with sample data for CAM vs CAM comparison. For an example of CAM simulation vs observations/reanalysis, navigate to <a href="">this demo</a>
# 
