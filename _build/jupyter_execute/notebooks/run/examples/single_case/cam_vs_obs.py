...
# For this example we will run the ADF diagnostics for an f-case CAM simulations for 5 years, 1995-2000 vs Observations/Reanalysis:
# 
...
# Open the new `config_cam_vs_obs.yaml` file with your favorite editor
# 
...
# 
# 
# <p style="margin-top: -5px;">&ensp; <code class="docutils literal notranslate"><span class="pre">compare_obs</span></code>: <code class="docutils literal notranslate"><span class="pre" style="color: black">true</span></code></p>
# 
...
#     
# <p>Now we can run the ADF with our new config file `config_cam_vs_obs.yaml`<a class="headerlink" href="#adf-run" title="Permalink to this heading">#</a></p>
# 
...
# <br><br><br><h4>End single CAM vs Obs case</h4>
# 
...
# 
# <p style="margin-top: -5px;">Check to see if this directory exists: <code class="docutils literal notranslate"><span class="pre">f.cam6_3_106.FLTHIST_v0a.ne30.dcs_non-ogw.001_1995_2000_vs_Obs/</span></code></p>
# </div>
# ```
# ````
# 
